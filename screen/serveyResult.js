...
import { StyleSheet, Text, View, TouchableOpacity, Alert, Picker,
...
export default class AnsweringQuestion extends Component {
  ...
  componentDidMount() {   
    ...
    return fetch('http://www.224tech.com/sasPhp/mcqQuestionlistResultJson.php', {
      method: 'POST',
      headers: {
          ...
          <Card>
              ...
              {dataSource.map(data =>    
                  <View style={styles.container2} key={data.mcq_ID}>
                      ...
                      <Text style={styles.instructions}>
                        Correct Answer: {data.mcq_Answer }
                      </Text>  
  
                      <Text style={styles.instructions}>
                        Your Answer: {data.your_Answer }
                      </Text> 
